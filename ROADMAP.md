...
3. `F44-EXP-01`
   Scope: build the guardrailed experimentation harness on top of the shipped analytics and design-system contracts without bypassing disclosure or consent rules.
   Conflict notes: shared analytics, shell, flow, and template surfaces in `src/lib/analytics.js`, future experiment config, and CTA/nav/funnel entry points; sequence carefully with any `F44-CNV-02` work.
